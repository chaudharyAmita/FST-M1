...
public class Activity4 {
    ...
    public void contactsTest() {
        ...
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='First name']")).sendKeys("Amulya");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Last name']")).sendKeys("Yarasani");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Phone']")).sendKeys("123455677345");
        ...
        Assert.assertEquals(contactName, "Amulya Yarasani");
    }
